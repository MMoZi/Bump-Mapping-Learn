...
Varyings SteepParallaxMappingVert(Attributes input){
...
half4 SteepParallaxMappingFrag(Varyings input) : SV_Target{
    ...
    half layerHeight = 1.0 / _LayerCount;
    [unroll(50)]
    while(currHeight < lastHeight ){
        lastHeight = lastHeight - layerHeight;
